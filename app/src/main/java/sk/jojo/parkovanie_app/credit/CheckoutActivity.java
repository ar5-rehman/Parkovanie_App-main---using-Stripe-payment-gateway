...
public class CheckoutActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String BACKEND_URL = "https://jpark-app.herokuapp.com/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stripe = new Stripe(
                ...
                Objects.requireNonNull("pk_test_51Iw9exAuLI7Bgs3ekE7HnBYeN7waq25sbCXYLChVDto8Zzu6yRYPaop8opEeCNcdErELWpywd8AFkS7IOETHHL9l00NsocFl8h")
        );
        ...
        public void onSuccess(@NonNull PaymentIntentResult result) {
            ...
            if (status == PaymentIntent.Status.Succeeded) {
                ...
                activity.displayAlert(
                        "Payment completed",
                        "Congrats, you have successfully purchased item!"
                );
